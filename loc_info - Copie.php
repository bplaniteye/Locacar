<?php if (isset($_SESSION["cli_id"])) {?>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>			
			...
			<td><?=mhe($row['depart.age_ville'])?></td>
			<td><?=mhe($row['arrivee.age_ville'])?></td>
			<td><?=mhe($row['cli_login'])?></td>
			<td><?=mhe($row['voi_immatriculation'])?></td><td><a class="btn btn-warning" href="<?=hlien("location","edit","id",$row["loc_id"])?>">Modifier</a></td>

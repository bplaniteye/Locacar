<?php if (isset($_SESSION["cli_id"])) {?>
    ...
    <p><a class="btn btn-primary" href="<?=hlien("location","reservation","id",0)?>">Faire une nouvelle location </a></p>
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<td><?=mhe($row['loc_voiture'])?></td><td>
			<a class="btn btn-warning" href="<?=hlien("location","edit","id",$row["loc_id"])?>">Modifier</a></td>
